...
- Identity requires a unique email address for new registrations. Legacy duplicate-email records are detected explicitly and return a clear conflict response instead of allowing ambiguous account lookup.

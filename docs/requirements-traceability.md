...
| Registration and login | `AuthController`, Identity, one-time email verification codes, password reset, JWT bearer configuration | Register, verify by code, sign in, and recover a password through Angular. |

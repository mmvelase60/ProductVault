...
| API integration | 5 | Exercises registration/roles, owner isolation, stock movements, admin authorization, and rotating refresh-session revocation through the real HTTP pipeline. |
...
| **Total** | **20** | Focused unit and integration tests of high-value business rules and security boundaries. |
